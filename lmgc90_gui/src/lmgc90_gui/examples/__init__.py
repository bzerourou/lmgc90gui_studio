...
EXAMPLES: list[ExampleSpec] = [
    ...
    ExampleSpec("mesh_rigids_from_file", "📐 Maillage → polygones (Carre.msh)", "Génération",
        "rigidsFromMesh2D sur Carre.msh + fondation JONCx (gen_sample).", 2, "Intermédiaire",
        mesh_rigids_from_file, tags=["mesh", "POLYG", "msh", "gen_sample"]),
    ExampleSpec("cylinder_deposit_3d", "🛢️ Cylindre 3D (dépôt)", "Génération",
        "1000 sphères depositInCylinder3D + fond PLANx + cylindre creux DNLYC.", 3, "Intermédiaire",
        cylinder_deposit_3d, tags=["granulo", "3D", "cylinder", "gen_sample"]),
    ...
    ExampleSpec("masonry_deformable_wall", "🧱 Mur maçonnerie déformable", "Structures",
        "gen_sample: Q4 stone + MAL_CZM + poutre de charge (COUPLED_DOF).", 2, "Expert",
        masonry_deformable_wall, tags=["masonry", "CZM", "deformable", "gen_sample"]),
